...
//
// A single persisted comment for a plan. FROZEN 5-key wire shape (see CONTRACT.md §"Sub-Plan
// 02 additions"). `block_line` is `number | null` (Rust `Option<i64>`, serde `null`), mirroring
